...
import com.jra.sampleecommerce.api.model.Tag;
import com.jra.sampleecommerce.controller.ProductController;
 ...
 **/
@Component
public class ProductRepresentationModelAssembler extends RepresentationModelAssemblerSupport<Product, ProductDTO> {
  ...
  public ProductDTO toModel(Product entity) {
    ProductDTO resource = createModelWithId(entity.getId(), entity);
   ...
   * @param entities
   */
  public List<ProductDTO> toListModel(Iterable<Product> entities) {
