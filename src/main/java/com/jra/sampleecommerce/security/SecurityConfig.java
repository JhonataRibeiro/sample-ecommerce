package com.jra.sampleecommerce.security;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.jra.sampleecommerce.model.entity.RoleEnum;
...
import static com.jra.sampleecommerce.security.Constants.API_DOCS;
import static com.jra.sampleecommerce.security.Constants.API_URL_PREFIX;
import static com.jra.sampleecommerce.security.Constants.AUTHORITY_PREFIX;
import static com.jra.sampleecommerce.security.Constants.PRODUCTS_URL;
import static com.jra.sampleecommerce.security.Constants.REFRESH_URL;
import static com.jra.sampleecommerce.security.Constants.ROLE_CLAIM;
import static com.jra.sampleecommerce.security.Constants.SIGNUP_URL;
import static com.jra.sampleecommerce.security.Constants.SWAGGER_URL;
import static com.jra.sampleecommerce.security.Constants.TOKEN_URL;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.httpBasic().disable()
                ...
                .cors()
                .and()
                .authorizeHttpRequests(req -> req.requestMatchers(new AntPathRequestMatcher(TOKEN_URL, HttpMethod.POST.name())).permitAll()
                        ...
                        .requestMatchers(new AntPathRequestMatcher(SWAGGER_URL, HttpMethod.GET.name())).permitAll()
